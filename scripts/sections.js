  ...
  function renderReferences(lang) {
    ...
    $('#reference-items').html(entries.map(function (entry, i) {
      return [
        ...
        '      <div class="row"><div class="col text-lg-left text-md-left"><img src="' + entry.image + '" alt="Image"></img></div></div>',
        '      <div class="row"><div class="col text-lg-left text-md-left"><a  href="https://www.linkedin.com/in/virgilioolivardia/details/recommendations/?detailScreenTabIndex=0">LinkedIn</a></div></div>',
